...
VideoChannel::VideoChannel(int stream_index,
...
{ // 第二线线程：视频：从队列取出原始包，播放 【真正干活了】
    ...
    cout << "文件的分辨率:" << codecContext->width << "x" << codecContext->height << endl;
    cout << "文件格式" << codecContext->pix_fmt << endl;
    // yuv -> rgba
